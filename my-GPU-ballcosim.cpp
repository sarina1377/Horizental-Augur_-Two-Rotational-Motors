...
void runBallDrop(ChSystemGpuMesh& gpu_sys, ChGpuSimulationParameters& params) {
   ...
   // Body for Stator1
    ...
    //mphysicalSystem.Set_G_acc(ChVector<>(0, 0, -980));
    int i = 0;
    chrono::ChMatrixNM<double, 120, 3> myforceR;
    chrono::ChMatrixNM<double, 120, 1> myforcexR;
    chrono::ChMatrixNM<double, 120, 1> myforceyR;
    chrono::ChMatrixNM<double, 120, 1> myforcezR;
    chrono::ChMatrixNM<double, 120, 1> PositionxR;
    chrono::ChMatrixNM<double, 120, 1> PositionyR;
    chrono::ChMatrixNM<double, 120, 1> PositionzR;
    chrono::ChMatrixNM<double, 120, 3> mytourqeR;
    chrono::ChMatrixNM<double, 120, 3> mytourqexR;
    chrono::ChMatrixNM<double, 120, 3> mytourqeyR;
    chrono::ChMatrixNM<double, 120, 3> mytourqezR;

    chrono::ChMatrixNM<double, 120, 3> myforceL;
    chrono::ChMatrixNM<double, 120, 1> myforcexL;
    chrono::ChMatrixNM<double, 120, 1> myforceyL;
    chrono::ChMatrixNM<double, 120, 1> myforcezL;
    chrono::ChMatrixNM<double, 120, 1> PositionxL;
    chrono::ChMatrixNM<double, 120, 1> PositionyL;
    chrono::ChMatrixNM<double, 120, 1> PositionzL;
    chrono::ChMatrixNM<double, 120, 3> mytourqeL;
    chrono::ChMatrixNM<double, 120, 3> mytourqexL;
    chrono::ChMatrixNM<double, 120, 3> mytourqeyL;
    chrono::ChMatrixNM<double, 120, 3> mytourqezL;
...
outdata.open("ForceRightAugur.dat"); // opens the file
...
outdata.open("ForceRightAugurX.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("ForceRightAugurY.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("FroceRightAugurZ.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("TourqeRightAugurX.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.close();
outdata.open("TouqreRightAugurY.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.close();
outdata.open("TouqreRightAugurZ.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.close();
outdata.open("TouqreRightAugur.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.close();
outdata.open("ForceLeftAugur.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("ForceLeftAugurX.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("ForceLeftAugurY.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("ForceLeftAugurZ.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("TourqeLeftAugurX.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.close();
outdata.open("TouqreLeftAugurY.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.close();
outdata.open("TouqreLeftAugurZ.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
///////////////////position
outdata.open("Right Augur Positionx.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.close();
outdata.open("Right Augur Positiony.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("Right Augur Positionz.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("Left Augur Positionx.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("Left Augur Positiony.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
...
outdata.open("Left Augur Positionz.dat"); // opens the file
if (!outdata) { // file couldn't be opened
    cerr << "Error: file could not be opened" << endl;
    exit(1);
}
